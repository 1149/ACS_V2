...
export const getOutboundParticipants = (outboundParticipants) => {
    if (outboundParticipants && outboundParticipants.length > 0) {
        const participants = outboundParticipants.map((participantId) => {
...
export const navigateToHomePage = () => {
    var _a;
    window.location.href = (_a = window.location.href.split('?')[0]) !== null && _a !== void 0 ? _a : window.location.href;
};
